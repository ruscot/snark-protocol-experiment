...
public class PolynomlialEvalWithPaillier extends Gadget {
	...
	public PolynomlialEvalWithPaillier(LongElement paillierModulus, Wire[] a, Wire[] b, int paillierKeyBitLength, String... desc) {
		super(desc);
